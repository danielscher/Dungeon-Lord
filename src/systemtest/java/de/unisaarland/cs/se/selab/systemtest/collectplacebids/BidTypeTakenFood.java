...
public class BidTypeTakenFood extends OurSystemTestFramework {
    public BidTypeTakenFood() {
        super(BidTypeTakenFood.class, false);
    }

    @Override
    public String createConfig() {
        return Utils.loadResource(BidTypeTakenFood.class, "configuration.json");
    }
    ...
    @Override
    public void bidsOfFirstSeasonFirstYear() throws TimeoutException {
