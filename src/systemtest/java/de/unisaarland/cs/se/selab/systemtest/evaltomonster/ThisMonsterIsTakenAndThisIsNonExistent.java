...
public class ThisMonsterIsTakenAndThisIsNonExistent extends OurSystemTestFramework {

    public ThisMonsterIsTakenAndThisIsNonExistent() {
        super(ThisMonsterIsTakenAndThisIsNonExistent.class, false);
    }
    ...
    protected void simulateFirstBiddingSeason() throws TimeoutException {
        ...
        // slot 2: (try to hire a taken monster then a non-existing one.)
