...
public class BidTypeTakenGold extends OurSystemTestFramework {
    public BidTypeTakenGold() {
        super(BidTypeTakenGold.class, false);
    }

    @Override
    public String createConfig() {
        return Utils.loadResource(BidTypeTakenGold.class, "configuration.json");
    }
