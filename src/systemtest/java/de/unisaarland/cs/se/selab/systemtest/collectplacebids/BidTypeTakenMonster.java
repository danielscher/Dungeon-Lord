...
public class BidTypeTakenMonster extends OurSystemTestFramework {
    public BidTypeTakenMonster() {
        super(BidTypeTakenMonster.class, false);
    }

    @Override
    public String createConfig() {
        return Utils.loadResource(BidTypeTakenMonster.class, "configuration.json");
    }
    ...
    protected void bidsOfFirstSeasonFirstYear() throws TimeoutException {
        ...
        bidPlacedAsserter(BidType.MONSTER, 3, 1);
        assertActNow(3);

        this.sendPlaceBid(3, BidType.ROOM, 2);
        bidPlacedAsserter(BidType.ROOM, 3, 2);
        assertActNow(3);
