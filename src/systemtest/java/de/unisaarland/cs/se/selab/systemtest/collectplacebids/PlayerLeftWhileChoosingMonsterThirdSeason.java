...
public class PlayerLeftWhileChoosingMonsterThirdSeason extends FrameworkuptoBiddingSecondSeason {
    public PlayerLeftWhileChoosingMonsterThirdSeason() {
        super(PlayerLeftWhileChoosingMonsterThirdSeason.class, false);
    }

    @Override
    public String createConfig() {
        return Utils.loadResource(PlayerLeftWhileChoosingMonsterThirdSeason.class,
                "configuration.json");
    }
    ...
    protected void simulateThirdBiddingSeason() throws TimeoutException {
        ...
        bidRetrievedAsserterHelper(BidType.TRAP, 2);
        ...
        adventurerArrivedAsserterHelper(26, 2);
    }
