...
public class BidTypeTakenImp extends OurSystemTestFramework {
    public BidTypeTakenImp() {
        super(BidTypeTakenImp.class, false);
    }

    @Override
    public String createConfig() {
        return Utils.loadResource(BidTypeTakenImp.class, "configuration.json");
    }
