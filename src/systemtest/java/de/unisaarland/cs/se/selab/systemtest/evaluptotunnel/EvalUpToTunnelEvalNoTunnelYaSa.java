 ...
 */
public class EvalUpToTunnelEvalNoTunnelYaSa extends OurSystemTestFramework {

    // this is to test in year 1 season 1 every player choose end turn.
    public EvalUpToTunnelEvalNoTunnelYaSa() {
        super(EvalUpToTunnelEvalNoTunnelYaSa.class, false);
    }

    @Override
    public String createConfig() {
        return Utils.loadResource(EvalUpToTunnelEvalNoTunnelYaSa.class, "configuration.json");
    }
