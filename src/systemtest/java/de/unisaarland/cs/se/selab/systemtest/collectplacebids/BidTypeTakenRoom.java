...
public class BidTypeTakenRoom extends OurSystemTestFramework {
    public BidTypeTakenRoom() {
        super(BidTypeTakenRoom.class, false);
    }

    @Override
    public String createConfig() {
        return Utils.loadResource(BidTypeTakenRoom.class, "configuration.json");
    }
