...
public class CantAffordTooEvilMonster extends OurSystemTestFramework {

    public CantAffordTooEvilMonster() {
        super(CantAffordTooEvilMonster.class, false);
    }

    @Override
    public String createConfig() {
        return Utils.loadResource(SystemTestTemplate.class, "config_mon9_99evil.json");
    }
    ...
    protected void simulateFirstBiddingSeason() throws TimeoutException {
        ...
        assertActNow(0);
        sendHireMonster(0, 9); // evilness : 99 can't afford
