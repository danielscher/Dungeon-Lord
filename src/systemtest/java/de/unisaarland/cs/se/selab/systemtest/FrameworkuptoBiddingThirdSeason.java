...
public class FrameworkuptoBiddingThirdSeason extends FrameworkuptoBiddingSecondSeason {
    ...
    protected FrameworkuptoBiddingThirdSeason(final Class<?> subclass, final boolean fail) {
        super(subclass, fail);
    }

    protected FrameworkuptoBiddingThirdSeason() {
        super(FrameworkuptoBiddingThirdSeason.class, false);
    }
